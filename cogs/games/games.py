...
from .modules.chessmod import ChessGame
...
from .modules.chessmod import ChessCommands
...
class Games(commands.Cog):
    ...
    async def chess(self, ctx: commands.Context,
        ...
        await ChessCommands.start_chess_game(ctx, opponent)
    ...
    async def chesslb(self,
        ...
        await ChessCommands.show_chess_leaderboard(ctx, player)
